<div data-role="task11663" data-position="1" id="task-num-0">
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11663" data-correction-id="20747792">
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11663" data-batch-id="62" data-toggle="modal" data-target="#task-11663-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11663-users-done-modal" data-task-id="11663" data-batch-id="62">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "0. Writing strings to Redis"</h4>
        </div>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11663}"><i aria-hidden="true" class="fa-solid fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-11663-modal" data-correction-id="20747792" data-task-id="11663">
...
<div data-role="task11664" data-position="2" id="task-num-1">
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11664" data-correction-id="20747792">
        <div class="task_progress_bar" style="width: 0.0%">
          <div class="task_score_bar" style="width: NaN%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11664" data-batch-id="62" data-toggle="modal" data-target="#task-11664-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11664-users-done-modal" data-task-id="11664" data-batch-id="62">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "1. Reading from Redis and recovering original type"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11664}"><i aria-hidden="true" class="fa-solid fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-11664-modal" data-correction-id="20747792" data-task-id="11664">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
...
<div data-role="task11665" data-position="3" id="task-num-2">
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11665" data-correction-id="20747792">
        <div class="task_progress_bar" style="width: 0.0%">
          <div class="task_score_bar" style="width: NaN%">
          </div>
        </div>
...
<p>Protip: when defining a decorator it is useful to use <code>functool.wraps</code> to conserve the original function’s name, docstring, etc. Make sure you use it as described <a href="/rltoken/eRjLY2hVLrkDcNkcDJDK3g" title="here" target="_blank">here</a>.</p>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11665" data-batch-id="62" data-toggle="modal" data-target="#task-11665-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11665-users-done-modal" data-task-id="11665" data-batch-id="62">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "2. Incrementing values"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11665}"><i aria-hidden="true" class="fa-solid fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-11665-modal" data-correction-id="20747792" data-task-id="11665">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
...
<div data-role="task11666" data-position="4" id="task-num-3">
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11666" data-correction-id="20747792">
        <div class="task_progress_bar" style="width: 0.0%">
          <div class="task_score_bar" style="width: NaN%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11666" data-batch-id="62" data-toggle="modal" data-target="#task-11666-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11666-users-done-modal" data-task-id="11666" data-batch-id="62">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "3. Storing lists"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11666}"><i aria-hidden="true" class="fa-solid fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-11666-modal" data-correction-id="20747792" data-task-id="11666">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
...
<div data-role="task11667" data-position="5" id="task-num-4">
  ...
  <div class="panel-body">
    ...
    <!-- Progress vs Score -->
      <div class="task_progress_score_bar" data-task-id="11667" data-correction-id="20747792">
        <div class="task_progress_bar" style="width: 0.0%">
          <div class="task_score_bar" style="width: NaN%">
          </div>
        </div>
...
<div>
  ...
  <button class="student-task-done-by btn btn-default btn-sm" data-task-id="11667" data-batch-id="62" data-toggle="modal" data-target="#task-11667-users-done-modal">
    Help
  </button>
  <div class="modal fade users-done-modal" id="task-11667-users-done-modal" data-task-id="11667" data-batch-id="62">
    <div class="modal-dialog">
        <div class="modal-content">
        <div class="modal-header">
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
            <h4 class="modal-title">Learners who are done with "4. Retrieving lists"</h4>
        </div>
        <div class="modal-body">
            <div class="list-group">
            </div>
    ...
    <button class="btn btn-default btn-sm" data-toggle="modal" data-target="#container-specs-modal" data-gtm-custom-event-name="task_sandbox_modal" data-gtm-custom-event-options="{&quot;taskId&quot;:11667}"><i aria-hidden="true" class="fa-solid fa-terminal "></i><span>Get a sandbox</span></button>
      ...
      <div class="modal fade task_get_qa_review" id="task-qa-review-11667-modal" data-correction-id="20747792" data-task-id="11667">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button>
